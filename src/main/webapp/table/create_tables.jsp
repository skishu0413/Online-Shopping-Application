...
try {
	...
	String q2 = "create table product(id int,name varchar(500),category varchar(200),price int,status varchar(10),image BLOB)";
	...
	String q4 = "create table message(id int AUTO_INCREMENT,email varchar(100),subject varchar(200),msgBody varchar(1000),PRIMARY KEY(id))";
